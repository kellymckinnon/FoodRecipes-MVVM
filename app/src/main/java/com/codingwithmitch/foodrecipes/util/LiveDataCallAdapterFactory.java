...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
  ...
  /**
   * This method performs a number of checks and then returns the Response type for the Retrofit
   * requests.
   *
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    // Check 2: Test type that LiveData is wrapping. This code gets "T"
    Type observableType =
    ...
    // Check 3: Check if ApiResponse is parameterized (must wrap around T)
